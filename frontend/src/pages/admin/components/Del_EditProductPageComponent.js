...
const EditProductPageComponent = ({
  ...
  const [categoryChosen, setCategoryChosen] = useState('Choose category'); //For creating own attr
  //To prevent submitting a new key/value attribute when one of them is empty
  ...
  //For attribute prevent default checks
